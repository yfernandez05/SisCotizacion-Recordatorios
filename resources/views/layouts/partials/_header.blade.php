<header class="navbar navbar-expand-md navbar-dark d-print-none">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="{{url('/')}}">
                <img src="{{asset('images/logo-light-text.png')}}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
        </h1>
        <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item d-none d-md-flex me-3">
                <div class="btn-list">
                    <a href="#" class="btn btn-dark" target="_blank" rel="noreferrer">
            ...
            <div class="d-none d-md-flex">
                ...
                <a href="?theme=light" class="nav-link px-0 hide-theme-light" title="Habilitar el modo de luz" data-bs-toggle="tooltip" data-bs-placement="bottom">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col text-truncate">
                                            ...
                                            <div class="d-block text-muted text-truncate mt-n1">
                                                Notificacion Recordatorio 01 (#29604)
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col text-truncate">
                                            ...
                                            <div class="d-block text-muted text-truncate mt-n1">
                                                Notificacion Recordatorio 01 - Nuevo (#29734)
                                            </div>
                                        </div>
                                        <div class="col-auto">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    <span class="avatar avatar-sm border"><img src="{{asset('images/users/1.jpg')}}" alt=""></span>
