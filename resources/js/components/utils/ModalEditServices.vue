<template>
    <div class="modal modal-blur fade" id="modal-detail-3" tabindex="-1" role="dialog" aria-hidden="true">
...
export default {
    ...
    watch:{
        showModal:function (newSelectValue, oldSelectValue) {
            ...
            var modal = new bootstrap.Modal(document.getElementById('modal-detail-3'), {});
    ...
    mounted(){
         let vm = this;
        let modaldetail = document.getElementById('modal-detail-3')
