    ...
    <div>     
        ...
        <main-content columnClass="col-12 col-md-10 col-lg-8 col-xl-9" colorTitle="text-white" v-if="!loadingholder">
            ...
            <template v-slot:card-body-main>
                <div class="row row-cards">
                    <div class="form-group col-12 col-sm-6 mb-3" :class="{'has-danger':errorExists('nombre')}">
                        <label class="form-label">Servicio <small class="text-danger">(*)</small></label>
                    ...
                    <div class="form-group col-12 col-sm-6 mb-3" :class="{'has-danger':errorExists('precio')}">
                    ...
                    <div class="form-group col-12 mb-3" :class="{'has-danger':errorExists('descripcion')}">
                        ...
                        <textarea type="text" class="form-control" v-model="servicio.descripcion" rows="2"></textarea>
            ...
            <template v-slot:card-body-actions>
                <router-link :to="{name: 'spa.tiposervicio'}" class="btn btn-outline btn-pill mr-2">
        ...
        methods: {
            ...
            validateFields() {
                ...
                if (!this.servicio.nombre) {
                    this.setError('nombre', 'El campo Servicio es obligatorio');
                }
                if (!this.servicio.precio) {
                    this.setError('precio', 'El campo Precio es obligatorio');
                }
