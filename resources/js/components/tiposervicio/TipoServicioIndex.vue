    ...
    <div>
        ...
        <main-content headerBgClass="bg-ligth" columnClass="col-12 col-xl-12" >
            ...
            <template v-slot:card-header-actions>
                ...
                <router-link :to="{name: 'spa.tiposervicio.registrar'}" class="btn btn-outline-success btn-pill" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Crear nuevo registro">
            ...
            <template v-slot:card-body-main>
                <div class="row mb-2">
                    <div class="form-group col-12 col-sm-6 col-md-4 col-xl-3 mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Ingrese un servicio" v-model="servicio.nombre" @keyup.enter="buscarServicio()"/>
                    </div>
...
<script>
    ...
    export default {
        data() {
            return {
                steps:[
                    {name:'Inicio', spa:'spa'},{name:'Tipos de Servicios', spa:``, active:'active'},
                ],
                servicios: [],
                pagination: {},
                filters: {},
