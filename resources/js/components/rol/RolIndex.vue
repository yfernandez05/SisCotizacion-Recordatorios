    ...
    <div>
        ...
        <main-content headerBgClass="bg-ligth" columnClass="col-12 col-xl-12" >
            ...
            <template v-slot:card-header-actions>
                <a class="btn btn-outline-info btn-pill" @click="buscarRol()" data-bs-toggle="tooltip" data-bs-placement="left" title="Buscar registros">
                ...
                <router-link :to="{name: 'spa.rol.registrar'}" class="btn btn-outline-success btn-pill" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Crear nuevo registro">
            ...
            <template v-slot:card-body-main>
                <div class="row mb-2">
                    <div class="form-group col-12 col-sm-6 col-md-4 col-xl-3 mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Ingrese un rol" v-model="rol.rol" @keyup.enter="buscarRol()"/>
                    </div>
                        ...
                        <div class="row g-2 mt-1">
                            <div class="col-auto d-flex align-items-center">
                                <label class="form-colorinput form-colorinput-light">
                                    <input name="color-rounded" type="checkbox" value="white" class="form-colorinput-input" id="estado" v-model="rol.estado" @change="buscarRol()"/>
                    ...
                    <table class="table table-sm table-striped table-hover table-bordered table">
                        ...
                        <tbody>
                            <tr v-for="itemRol in roles" :key="itemRol.idrol">
                                <td>
                                    <row-actions :rowData="itemRol" @rowItemActions="rowItemActions" :activeDelete="false" :activeShow="false">
                                        <button type="button" :title="itemRol.isactive ? 'Desactivar':'Activar'" @click="cambiarEstado(itemRol)"
                                            class="btn btn-sm  waves-effect waves-light border-0 mr-1"
                                            :class="itemRol.isactive ? 'btn-outline-danger':'btn-outline-success'">
                                            <i class="fas fa-lg" :class="itemRol.isactive ? 'fa-trash':'fa-check-circle'"></i>
                                        </button>
                                    </row-actions>
                                </td>
                                ...
                                <td>
                                    <span class="badge badge-pill py-1 px-3" :class="itemRol.isactive ? 'badge bg-green-lt':'badge bg-red-lt'" v-text="itemRol.statename" ></span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<script>
    ...
    export default {
        data() {
            return {
                steps:[
                    {name:'Inicio', spa:'spa'},{name:'Rol', spa:``, active:'active'},
                ],
                roles: [],
                pagination: {},
                filters: {},
        ...
        methods: {
            ...
            cambiarEstado(param){
                ...
                swalAlertConfirm(`¿Seguro que quiere ${optionMessage} el Rol <b>${param.rol}</b>?`, appName)
