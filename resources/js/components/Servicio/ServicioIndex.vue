    ...
    <div>
        ...
        <main-content headerBgClass="bg-ligth" columnClass="col-12 col-xl-12" >
            ...
            <template v-slot:card-header-actions>
                ...
                <router-link :to="{name: 'spa.servicios.registrar'}" class="btn btn-outline-success btn-pill" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Crear nuevo registro">
